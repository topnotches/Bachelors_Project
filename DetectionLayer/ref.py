...
flags.DEFINE_float('yolo_iou_threshold', 0.8, 'iou threshold')
flags.DEFINE_float('yolo_score_threshold', 0.8, 'score threshold')
...
def YoloOutput(filters, anchors, classes, name=None):
    def yolo_output(x_in):
        ...
        x = tf.keras.layers.Reshape((7, 7, anchors, classes + 5))(x)
...
def BotBlock(x, filters_in,filters_out, padding = 'same', strides = 1, expansion = 1, add = False, cheatcodes = False):
