...
def main(_argv):
    ...
    float_model = tf.keras.models.load_model('new_model.h5', custom_objects= {'tf':tf,'yolo_boxes':yolo_boxes})
    ...
    quantized_model = quantizer.quantize_model(calib_dataset=val_dataset, calib_batch_size=None, include_fast_ft=True,fast_ft_epochs=10)
